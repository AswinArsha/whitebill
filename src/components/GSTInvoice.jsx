...
const GSTInvoice = React.forwardRef(({ invoiceData }, ref) => {
  ...
  const amountWords = capitalizeWords(
    amountInWords || `${toWords(Math.floor(totalAmount))} Rupees`
  );
      ...
      <table className="w-full border-collapse border border-gray-400 mb-8">
        ...
        <tbody>
          ...
          <tr>
            <td
              colSpan="5"
              className="border border-gray-300 p-2 text-right text-md font-semibold"
            >
              Round Off
            </td>
            <td className="border border-gray-300 p-2 text-md text-right">
              {roundOff}
            </td>
          </tr>
          <tr>
            <td
              colSpan="5"
              className="border border-gray-300 p-2 text-md text-right font-semibold"
            >
              Total
            </td>
            <td className="border border-gray-300 p-2 font-semibold text-md text-right">
              {totalAmount}
            </td>
          </tr>
        </tbody>
